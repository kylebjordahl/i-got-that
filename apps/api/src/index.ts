...
import { emailUnsubscribeRoutes, emailVerifyRoutes } from './routes/email-outputs.js';
...
// …and the unsubscribe link in every mail an output sends.
app.route('/email', emailUnsubscribeRoutes);
