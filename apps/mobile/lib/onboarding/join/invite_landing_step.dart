...
class _InviteLandingStepState extends ConsumerState<InviteLandingStep> {
  ...
  Future<void> _loadPreview() async {
    try {
      ...
      if (mounted) {
        setState(() => _error = 'This invite link is invalid or expired.');
      }
    }
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    'Just one quick step after this.',
...
class _Monogram extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        initial,
        style: font(kDisplayFont, 26, 700, color: const Color(0xFF06243F)),
      ),
    );
  }
}
