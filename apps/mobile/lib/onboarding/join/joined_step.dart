...
class JoinedStep extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final target = self == null
        ? null
        : ref.watch(memberCalendarProvider(self.id)).valueOrNull;
                    ...
                    children: [
                      ...
                      if (calendarPicked)
                        Text.rich(
                          TextSpan(
                            text:
                                "That's all it took. The family setup was already "
                      ...
                      GroupedCard(
                        children: [
                          ReceiptRow(
                            ...
                            text:
                                'Joined ${info?.name ?? 'the family'} as a caretaker',
                          ),
                          if (calendarPicked)
                            const ReceiptRow(
                              done: true,
                              text: 'Your unified calendar connected',
                            )
                          else
                            const ReceiptRow(
                              done: false,
                      ...
                      Text(
                        'Delivery reminders, task lists & email notices can be '
