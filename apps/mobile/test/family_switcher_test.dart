...
void main() {
  ...
  testWidgets(
    'the header is a plain title when the account has only one family',
    (tester) async {
      await pumpTall(
        tester,
        screen([
  ...
  testWidgets(
    ...
    'and switching updates the selected family',
    (tester) async {
  ...
  testWidgets(
    ...
    'Family screen intact, instead of leaving a blank screen',
    (tester) async {
